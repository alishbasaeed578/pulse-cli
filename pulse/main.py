...
from .ai_utils import generate_standup_summary
...
def generate(
    ...
    """
    Generate a standup update based on local git commits using GROQ.
    """
    ...
    console.print(f"📜 Found [bold green]{len(commits)}[/bold green] commit(s). Generating standup with GROQ...")

    with console.status("[bold magenta]Asking GROQ to synthesize standup...[/bold magenta]"):
